...
<?php
    ...
    $runresult1 = mysqli_query($conn, $speciescount);
    $speciescount = mysqli_fetch_array($runresult1);
    $speciescount = $speciescount[0];

    //query for total family count
    $familycount = "select count(distinct family_id) from species_info";
    $runresult2 = mysqli_query($conn, $familycount);
    $familycount = mysqli_fetch_array($runresult2);
